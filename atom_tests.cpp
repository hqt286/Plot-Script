...
TEST_CASE( "test comparison", "[atom]" ) {
...

  {
    ...
    Atom b("hi");
    Atom c("bye");
	REQUIRE(a.asComplexNumber() == ComplexNumber(0, 0));
    REQUIRE(a == b);
    REQUIRE(a != c);
  }

  {
	  ...
	  INFO ("compare complex to complex (same real different imag)")
	  {
		  Atom a(ComplexNumber(4.4, 5));
		  Atom b(ComplexNumber(4, 5));
		  REQUIRE(a.asComplexNumber() == ComplexNumber(4.4, 5));
		  REQUIRE(a != b);
	  }
	  INFO("compare complex to complex (same imag different real)")
	  {
		  Atom a(ComplexNumber(4, 5.5));
		  Atom b(ComplexNumber(4, 5));
		  REQUIRE(a != b);
	  }
	  INFO("compare complex to complex (same for both)")
	  {
		  Atom a(ComplexNumber(4, 5));
		  Atom b(ComplexNumber(4, 5));
		  REQUIRE(a == b);
